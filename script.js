...
'<li><a href="' + relativePath + '/fiction.html">Lynn's Books</a></li>' + 
'<li><a href="' + relativePath + '/services.html">Marketing Services</a></li>' + 
...
//Note: feel free to remove the references to Zonelets and Neocities! Just be careful not to delete any necessary HTML closing tags or other syntax.
  let footerHTML = "<hr><p>" + blogName + " is written by <a href='" + authorLink + "'>" + authorName + "</a>, built with <a href='https://zonelets.net/'>Zonelets</a>, and last updated Dec 26, 2025!</p>";
...
let recentPostListHTML = "<h1>Latest Posts:</h1><ul>";
